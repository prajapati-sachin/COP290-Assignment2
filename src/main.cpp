...
int main(int argc, char **argv) {
	...
	for(int i=0;i<500;i++){
		...
		flag = rand()%2;
		if(flag==1){
			temp_direction.i = (rand()%3)+3;
		}else{	temp_direction.i = -(rand()%3)-3;}

		flag = rand()%2;
		if(flag==1){
			temp_direction.j = 0.1;
		}else{temp_direction.j = 0.1;}

		flag = rand()%2;
		if(flag==1){
			temp_direction.k = (rand()%3)+3;
		}else{temp_direction.k = -(rand()%3)-3;}
