...
CXX = g++
LFLAGS        = -m64
CXXFLAGS      = -g -m64 -std=c++11 -pipe -O2 -Wall -W -D_REENTRANT $(DEFINES) -Wno-sign-compare -Wno-unused-result -Wno-unused-variable -Wno-unused-parameter -Wuninitialized -L /lib64 	
